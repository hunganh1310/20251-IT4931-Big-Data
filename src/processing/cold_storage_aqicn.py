...
def push_raw_json_minio(message, client: Minio):
    ...
    object_name = f"aqicn/{current_date.year}/{current_date.month:02d}/{current_date.day:02d}/{message.offset}.json"
...
def main():
    logger.info("Starting cold storage archiver for AQICN")
